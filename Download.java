...
public class Download extends HttpServlet {
 ...
 /*   public void CreateBdTable() {
    	try{
            String url = "jdbc:postgresql://localhost/logs";
            String username = "postgres";
            String password = "vnc9094842";
            Class.forName("org.postgresql.Driver").getDeclaredConstructor().newInstance();
            String sqlCommand = "CREATE TABLE log (Id SERIAL,  FileName VARCHAR(256),ContentType VARCHAR(256), SizeInBytes VARCHAR(256))";
     //       String sqlCommand = "DROP TABLE log";
    ...
    */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.setContentType(mimeType != null? mimeType:"application/octet-stream");//используем т.к тип файла будет неизвестен
    ...
    public void downloadFile(File file,HttpServletResponse response,InputStream fis)throws ServletException, IOException { //метод загрузки файла
    	
    	ServletOutputStream os       = response.getOutputStream();		//процесс загрузки файла
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.write("<form action =" + " http://localhost:8080/Cloud"+">"+"<button style="+"width:200px;height:50px"+">Back</button></form>");
    }
